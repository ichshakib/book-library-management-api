...
export class PassportService {
  ...
  initializeStrategies() {
    ...
    this.passport.use(
      new GoogleStrategy(
        {
          clientID: GOOGLE_CLIENT_ID || "placeholder_client_id",
          clientSecret: GOOGLE_CLIENT_SECRET || "placeholder_client_secret",
    ...
    this.passport.use(
      new GitHubStrategy(
        {
          clientID: GITHUB_CLIENT_ID || "placeholder_client_id",
          clientSecret: GITHUB_CLIENT_SECRET || "placeholder_client_secret",
