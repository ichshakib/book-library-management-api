...
[![CI](https://github.com/ichshakib/book-library-management-api/actions/workflows/ci.yml/badge.svg)](https://github.com/ichshakib/book-library-management-api/actions/workflows/ci.yml)
...
<p align="center">
  <picture>
    ...
    <img alt="Book Library Management System Preview" src="public/images/dark.png" width="100%">
  </picture>
</p>
...
| :------------------------------------------: | :--------------------------------------------: |
| ![Dark Mode Preview](public/images/dark.png) | ![Light Mode Preview](public/images/light.png) |
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/ichshakib/book-library-management-api.git
...
- **ichshakib** - [GitHub Profile](https://github.com/ichshakib)

## 📬 Contact

- **Maintainer**: [ichshakib](https://github.com/ichshakib)
...
4. Open an issue on [GitHub Issues](https://github.com/ichshakib/book-library-management-api/issues)
5. Reach out via email at [ichshakib@gmail.com](mailto:ichshakib@gmail.com)
